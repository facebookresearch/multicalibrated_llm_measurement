...
│   └── prevalence_bias_simulation.ipynb  # Interactive notebook
├── acs_analysis/
│   ├── run_acs.py               # Reproduction script (Figure 2)
│   ├── helpers.py               # ACS helper functions
│   └── acs_exploration.ipynb    # Interactive notebook
├── cap_analysis/
│   ├── opus/
...
│   ├── llama/
│   │   ├── cap_analysis.ipynb   # Llama analysis (SI Appendix S2)
...
See `cap_analysis/llama/inference/` for inference scripts and
`cap_analysis/llama/cap_analysis.ipynb` for the analysis notebook.
